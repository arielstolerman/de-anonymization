...
/**
 * Class for optimizing egonet counting. Calculates summary counts once for each node,
 * even though each node may be used in multiple egonets. By supplying the Egonet object
 * with these counts, it lazily doesn't go calculate them itself. Summary counts are given
 * to the Egonet constructor (for non-attribute counts) and to the getCounts call (for
 * attribute counts).
 * 
 * 
 * @author henderson43
