...
public class Egonet{
	 ...
	 * 
	 * This constructor can be used to optimize if many egonets are going to be 
	 * constructed from the same graph. To do so, populate inLinks, outLinks, 
	 * totalIn and totalOut for all nodes in the graph. This avoids recalculation.
	 * 
	 *  
	 * @param centers
	 * @param level
